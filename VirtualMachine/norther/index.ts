        ...
        folder: [
            {
                ...
                dns: ["192.168.0.1"],
                virtualmachine: [
                    { name: "node01", ip: "192.168.0.121", cpus: 10, memory: 32768, disk: 300 },
                    { name: "node02", ip: "192.168.0.122", cpus: 10, memory: 32768, disk: 300 },
                    { name: "node03", ip: "192.168.0.123", cpus: 10, memory: 32768, disk: 300 },
                    { name: "node04", ip: "192.168.0.124", cpus: 10, memory: 32768, disk: 300 }
                ]
            },
        ]
    }
